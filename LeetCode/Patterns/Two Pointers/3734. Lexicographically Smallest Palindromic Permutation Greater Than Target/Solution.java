class Solution {
    public String lexPalindromicPermutation(String s, String target) {
        ...
        // Try to construct smallest half > target's first half
    ...
    private boolean build(char[] half, int pos, int[] freq,
        ...
        // Try smaller/equal/greater characters
        for (int c = 0; c < 26; c++) {
            ...
            // If already greater, fill remaining positions smallest
            if (c > t) {
